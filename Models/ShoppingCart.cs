...
namespace MovieStore.Models
{
    public class ShoppingCart
    {
        ...
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(s => s.Movie.MovieId == movie.MovieId && s.ShoppingCartId == ShoppingCartId);
        ...
        public int RemoveFromCart(Movie movie)
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(
                s => s.Movie.MovieId == movie.MovieId && s.ShoppingCartId == ShoppingCartId);
